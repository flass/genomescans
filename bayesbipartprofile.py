...
def usage():
	...
	s += "\t\t\t\t\t  e.g. in case of heterogeneous presence/absence of genes in taxa, or when providing an alternative consensus tree \n"
	s += "\t\t\t\t\t  (rather than the native MrBayes ones) in Newick format that does not carry the information of the right taxon order.\n"
	s += "\t\t\t\t\t  Defaults to the order given in the first consensus gene tree, incremented by new taxa incountered in following gene trees.\n"
